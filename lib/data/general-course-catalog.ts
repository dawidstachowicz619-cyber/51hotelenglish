...
export const GENERAL_COURSE_CATALOG: CatalogCourse[] = [
  ...
  {
    id: "catalog-russian-scenarios",
    title: "酒店俄语 · 场景课程",
    description:
      "前厅、餐饮、客房三大场景，中俄英三语对照，含单词、常用句、情景对话与选择题练习。",
    category: "russian",
    phase: "role",
    ask: "skill",
    durationMinutes: 60,
  ...
  {
    id: "catalog-russian-campaign",
    title: "酒店俄语 · 闯关学习",
    description:
      "客房与餐饮各 30 关，每关 5 句 + 5 词，逐关解锁测验，适合系统化在岗学习。",
    category: "russian",
    phase: "role",
    ask: "skill",
    durationMinutes: 90,
    ...
    delivery: {
      type: "link",
      href: "/courses/russian/campaign",
      linkLabel: "开始闯关",
    },
  },
  {
    id: "catalog-russian-daily",
    title: "俄语每日打卡",
    description: "每天 5 个词汇 + 图卡学习与小测验，连续打卡赢积分，适合碎片化学习。",
    category: "russian",
    phase: "general",
    ask: "skill",
    durationMinutes: 15,
    ...
    delivery: {
      type: "link",
      href: "/courses/russian/daily",
      linkLabel: "今日打卡",
    },
  },
  {
    id: "catalog-russian-room-items",
    title: "客房物品俄语 100",
    description: "床品、清洁用品、客房设施等 100 个常用词，图卡 + 听发音 + 选择题巩固。",
    category: "russian",
    phase: "role",
    ask: "knowledge",
    durationMinutes: 40,
    ...
    delivery: {
      type: "link",
      href: "/courses/russian/room-items",
      linkLabel: "学习客房词汇",
    },
  },
  {
    id: "catalog-russian-dining-items",
    title: "餐饮物品俄语 100",
    description: "餐具、食材、饮品等 100 个餐饮常用词，图卡学习 + 语音跟读 + 练习测验。",
    category: "russian",
    phase: "role",
    ask: "knowledge",
    durationMinutes: 40,
    ...
    delivery: {
      type: "link",
      href: "/courses/russian/dining-items",
      linkLabel: "学习餐饮词汇",
    },
  },
  {
